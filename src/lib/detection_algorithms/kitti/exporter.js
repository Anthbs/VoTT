        ...
        return new Promise((resolve, reject) => {
            async.waterfall([
                ...
                function saveImage(cb) {
                    ...
                    console.log("Image",isTestFrame, self.testFrameIndices, self.posFrameImageIndex, outputDirPath, imageFilePath);
                ...
                function saveLabel(cb) {
                    ...
                    console.log("Label",isTestFrame, self.testFrameNames, self.posFrameImageIndex, outputDirPath, labelFilePath);
                    var labelData = '';
                    for (var i in tags) {
                        if (i > 0) {
                            labelData += '\n';
